      ...
      <div className="container mx-auto bg-[var(--primary-color)]  flex justify-between items-center  text-center">
        <div className="bg-[var(--primary-color)] "> 
          <Image
            ...
            className=" bg-[var(--primary-color)] <img class="rounded-full w-16 h-16" src="https://dummyimage.com/70x70" alt="Image" />   w-36 h-36 "
          />
        </div>
        ...
        <button 
          onClick={toggleMenu}
          className="md:hidden text-gray-600 hover:text-blue-500 transition-colors mr-5"
        >

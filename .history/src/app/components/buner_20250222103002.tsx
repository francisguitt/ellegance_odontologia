...
function Bunner() {
    ...
    const slides = [
        {
            image: 'https://img.freepik.com/fotos-gratis/paciente-jovem-fazendo-procedimento-odontologico-no-ortodontista_23-2148985755.jpg?uid=R158697381&ga=GA1.1.2111296288.1739707750&semt=ais_hybrid',
